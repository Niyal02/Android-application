...
//    private static ArrayList<Book> currentlyReading;
    ...
    public ArrayList<com.example.androidbasics.Book> getBooks() {
        Gson gson = new Gson();
        Type type = new TypeToken<ArrayList<com.example.androidbasics.Book>>(){}.getType();
        ArrayList<com.example.androidbasics.Book> books = gson.fromJson(sharedPreferences.getString(ALL_BOOK_KEY, null), type);
        return books;
    }
